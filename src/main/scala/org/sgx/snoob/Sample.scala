...
val s1 = "hello world".length
val s2 = "hello world".substring(2, 6)
val s3 = "hello world".replace("C", "3")

// They also have some extra Scala methods. See also: scala.collection.immutable.StringOps
val s4 = "hello world".take(5)
val s5 = "hello world".drop(5)

// String interpolation: notice the prefix "s"
val n = 45
val s6 = s"We have $n apples" // => "We have 45 apples"

// Expressions inside interpolated strings are also possible
val a1 = Array(11, 9, 6)
val s7 = s"My second daughter is ${a1(0) - a1(2)} years old."    // => "My second daughter is 5 years old."
val s8 = s"We have double the amount of ${n / 2.0} in apples." // => "We have double the amount of 22.5 in apples."
val s9 = s"Power of 2: ${math.pow(2, 2)}"                      // => "Power of 2: 4"

// Formatting with interpolated strings with the prefix "f"
val s10 = f"Power of 5: ${math.pow(5, 2)}%1.0f"         // "Power of 5: 25"
val s11 = f"Square root of 122: ${math.sqrt(122)}%1.4f" // "Square root of 122: 11.0454"

// Raw strings, ignoring special characters.
val s12 = raw"New line feed: \n. Carriage return: \r." // => "New line feed: \n. Carriage return: \r."

// Some characters need to be "escaped", e.g. a double quote inside a string:
val s13 = "They stood outside the \"Rose and Crown\"" // => "They stood outside the "Rose and Crown""
...
def sq0(x: Int) = x * x  // Compiler can guess return type is Int
...
println(i)    // Show the value of i. Note that while is a loop in the classical sense -
...
if (x1 == 1) println("yeah")
if (x1 == 10) println("yeah")
if (x1 == 11) println("yeah")
if (x1 == 11) println("yeah") else println("nay")

println(if (x1 == 10) "yeah" else "nope")
...
val a2 = Array(1, 2, 3, 5, 8, 13)
a2(0)     // Int = 1
a2(3)     // Int = 5
a2(21)    // Throws an exception
...
def matchStrings(obj: String): String = obj match {
  // You can match values:
  case "Hello world" => "Got the string Hello world"
...
val nPlain2 = for { n <- s } yield sq(n)
...
val writer = new java.io.PrintWriter("myfile.txt")
